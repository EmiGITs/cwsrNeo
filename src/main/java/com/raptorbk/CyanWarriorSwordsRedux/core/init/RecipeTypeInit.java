...
public class RecipeTypeInit {
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<TransmutationRecipe>> TRANSMUTATION = RECIPE_TYPES.register("transmutation", () -> new RecipeType<TransmutationRecipe>() {
    });
}