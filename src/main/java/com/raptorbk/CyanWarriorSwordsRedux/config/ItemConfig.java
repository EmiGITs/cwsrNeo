...
public class ItemConfig {
    ...
    private static String format(String message) {
        return String.format("[%s] %s", CyanWarriorSwordsRedux.MOD_ID, message);
    }
    ...
    public static void load() {
        ...
        try {
            ...
            CyanWarriorSwordsRedux.logger.error(e.getMessage());
            CyanWarriorSwordsRedux.logger.error(format("Unable to load configuration file!"));
        }
    ...
    private static void save() {
        try {
           ...
           CyanWarriorSwordsRedux.logger.error(e.getMessage());
           CyanWarriorSwordsRedux.logger.error(format("Unable to save configuration file!"));
        }
    }
    ...
    private static void convert(int version) {
       ...
       CyanWarriorSwordsRedux.logger.info(format("Converted outdated config."));
    }
    ...
    private static void repair() {
        ...
        if (repaired > 0) {
           CyanWarriorSwordsRedux.logger.info(format("Repaired " + repaired + " config properties"));
        }
